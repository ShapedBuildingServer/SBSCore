...
use xenialdan\MagicWE2\commands\ReplCommand;
use MyPlot\MyPlot;
...
class Loader extends PluginBase{
	...
	public function onLoad(){
		...
		self::$myPlot = $this->getServer()->getPluginManager()->getPlugin("MyPlot");
	}
	 ...
	 * @return MyPlot|null
	 */
	public static function getMyPlot() : ?MyPlot{
		return self::$myPlot;
	}
	/**
	 * @return bool
	 */
	public static function isMyPlotAvailable() : bool{
		return self::$myPlot !== null;
	}
